            ...
            <form className="mt-8 space-y-4">
              ...
              <div className="flex flex-wrap items-center justify-between gap-4">
                <div className="flex items-center">
                  ...
                  />
                  <label htmlFor="keep me signed in" className="ml-3 block text-sm text-gray-800">
                    Keep me signed in
                  </label>
                </div>
              ...
              <p className="text-gray-800 text-sm mt-8 text-center">
                  Not a Member?{' '}
                <Link href="/join-us" className="text-blue-600 hover:underline ml-1 whitespace-nowrap font-semibold">
                  Join Us
                </Link>
              </p>
            </form>
